import entityFilter from '../../../js/common/util/entity_filter.js';
...
describe('EntityFilter', () => {
  ...
  it('allows whitelisting entities by entity id', () => {
    const filter = entityFilter(null, ['light.kitchen']);
  ...
  it('allows whitelisting entities by domain', () => {
    const filter = entityFilter(['switch']);
  ...
  it('allows blacklisting entities by entity id', () => {
    const filter = entityFilter(null, null, null, ['light.kitchen']);
  ...
  it('allows blacklisting entities by domain', () => {
    const filter = entityFilter(null, null, ['switch']);
  ...
  it('allows whitelisting domain and blacklisting entity', () => {
    const filter = entityFilter(['switch'], null, null, ['switch.kitchen']);
  ...
  it('allows whitelisting entity while whitelisting other domains', () => {
    const filter = entityFilter(['switch'], ['light.kitchen']);
  ...
  it('allows blacklisting domain and whitelisting entity', () => {
    const filter = entityFilter(null, ['switch.kitchen'], ['switch']);
  ...
  it('allows blacklisting domain and excluding entities', () => {
    const filter = entityFilter(null, null, ['switch'], ['light.kitchen']);
